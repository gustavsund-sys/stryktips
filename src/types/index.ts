...
export interface Round { roundDate: string; updatedAt: string; status: 'ok' | 'partial'; matches: Match[]; sources: Record<string, SourceStatus>; expertCount: number; systemRows: number; publicDistribution: null; }
